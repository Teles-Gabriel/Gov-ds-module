  ...
  <body>
    <div class="container-fluid">
      <div class="container-lg">
        <p class="h4 mt-5">Notification</p>
              ...
              <nav class="tab-nav">
                <ul>
                  <li class="tab-item notification-tooltip">
                    <button type="button" aria-label="Alertas" data-panel="notification-panel-1-90782" data-tooltip-text="Alertas"><span class="name"><i class="fas fa-bell" aria-hidden="true"></i></span></button>
                  </li>
                  <li class="tab-item notification-tooltip active">
                    <button type="button" aria-label="Mensagens" data-panel="notification-panel-2-90782" data-tooltip-text="Mensagens"><span class="name"><i class="fas fa-envelope" aria-hidden="true"></i></span></button>
                  </li>
                </ul>
              </nav>
              <div class="tab-content">
                <div class="tab-panel" id="notification-panel-1-90782">
                  <div class="br-list">
                    <button class="br-item" type="button"><i class="fas fa-heartbeat mr-2" aria-hidden="true"></i>Link de Acesso
                    </button>
                    <button class="br-item" type="button"><i class="fas fa-heartbeat mr-2" aria-hidden="true"></i>Link de Acesso
                    </button>
                    <button class="br-item" type="button"><i class="fas fa-heartbeat mr-2" aria-hidden="true"></i>Link de Acesso
                ...
                <div class="tab-panel active" id="notification-panel-2-90782">
                  <div class="br-list">
                    <button class="br-item" type="button" role="contentinfo" aria-label="Especificar aqui a mensagem de alerta a ser informado pelo leitor de tela"><span class="br-tag status small warning"></span><span class="text-bold">Título</span><span class="text-medium mb-2">25 de out</span><span>Nostrud consequat culpa ex mollit aute. Ex ex veniam ea labore laboris duis duis elit. Ex aute dolor enim aute Lorem dolor. Duis labore ad anim culpa. Non aliqua excepteur sunt eiusmod ex consectetur ex esse laborum velit ut aute.</span>
                    </button>
