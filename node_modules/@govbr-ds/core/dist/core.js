...
class BRCookiebar {
  ...
  _setPoliticsButtonBehavior() {
    this.component.querySelectorAll(_selectors__WEBPACK_IMPORTED_MODULE_2__/* .POLITICS_BUTTON */ .Nx).forEach((politicsButton) => {
      // Expande o cookiebar
  ...
  _setCloseButtonBehavior() {
    this.component.querySelectorAll(_selectors__WEBPACK_IMPORTED_MODULE_2__/* .CLOSE_BUTTON */ .qy).forEach((closeButton) => {
      ...
      closeButton.addEventListener('click', () => {
        ...
        this.component.querySelector(_selectors__WEBPACK_IMPORTED_MODULE_2__/* .POLITICS_BUTTON */ .Nx).classList.remove('d-none')
        document.body.style.overflowY = 'auto'
  ...
  _setWindowResizeBehavior() {
    window.addEventListener('resize', () => {
      ...
      this.component.querySelectorAll(_selectors__WEBPACK_IMPORTED_MODULE_2__/* .ACTION_BUTTONS */ .TZ).forEach((button) => {
  ...
  _handleToggleGroupClick(event) {
    ...
    if (element.classList.contains('open')) {
      ...
      element.nextElementSibling.querySelectorAll(_selectors__WEBPACK_IMPORTED_MODULE_2__/* .BR_SWITCH */ .ke).forEach((check) => {
  ...
  _setCheckboxBehavior() {
    this.component.querySelectorAll(_selectors__WEBPACK_IMPORTED_MODULE_2__/* .PARENT_CHECKBOX */ .Fx).forEach((trigger) => {
  ...
  _displayBroadAlertMessage() {
    this.component.querySelectorAll(_selectors__WEBPACK_IMPORTED_MODULE_2__/* .BROAD_ALERT */ .kM).forEach((broadAlert) => {
  ...
  _displayGroupAlertMessage(groupIndex) {
    const group = this.component.querySelectorAll(_selectors__WEBPACK_IMPORTED_MODULE_2__/* .GROUP_INFO */ .JO)[groupIndex]
  ...
  _displayCookieAlertMessage(groupIndex, cookieIndex) {
    const group = this.component.querySelectorAll(_selectors__WEBPACK_IMPORTED_MODULE_2__/* .GROUP_INFO */ .JO)[groupIndex]
    const cookie = group.nextElementSibling.querySelectorAll(_selectors__WEBPACK_IMPORTED_MODULE_2__/* .COOKIE_CARD */ .kq)[cookieIndex]
  ...
  _showCookiebar() {
    ...
    switch (this.mode) {
      case 'open':
        this.component.classList.remove('default')
        this.component.querySelectorAll(_selectors__WEBPACK_IMPORTED_MODULE_2__/* .POLITICS_BUTTON */ .Nx).forEach((button) => {
  ...
  _setOpenView() {
    ...
    const containerFluid = this.component.querySelector(_selectors__WEBPACK_IMPORTED_MODULE_2__/* .CONTAINER_FLUID */ .X8)
